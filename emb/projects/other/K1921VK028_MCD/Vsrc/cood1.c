// Файл:
// Профиль: W:\ProjectsGit\motorcontroldemo_028\cood.xml
// Конфигурация: Базовый профиль
// Дата создания: 25.12.2020 15:32:12
...
// всего 129 индексов в словаре
// всего 878 элементов в словаре
...
(long)(&co1_vars.co_blockTransferCommand),	//[2700h.00h], Название: Block Transfer Interpreter, ТекстПУ: BT Interpreter, Группа: Слово управления
...
(long)(&adc.Udc_meas_gain),	//[5116h.0Ah], Название: Коэффициент напряжения ЗПТ, ТекстПУ: UdУсил, Группа: АЦП
(long)(&adc.Udc_meas_offset),	//[5116h.0Bh], Название: Смещение напряж. ЗПТ, ТекстПУ: Udсмещ, Группа: АЦП
(long)(&adc.Udc_meas),	//[5116h.0Ch], Название: Напряжение ЗПТ, ТекстПУ: Ud, Группа: АЦП
(long)(&adc.T_meas_gain),	//[5116h.0Dh], Название: Коэффициент температуры, ТекстПУ: t_gain, Группа: АЦП
(long)(&adc.T_meas),	//[5116h.0Eh], Название: Температура, ТекстПУ: t, Группа: АЦП
...
(long)(&dlog.update_sample_rate),	//[5150h.0Bh], Название: Частота даталогера, ТекстПУ: dlogFreq, Группа: dlog
...
(long)(&UserMem.MemStartAddr),	//[5174h.15h], Название: Адрес в EEPROM, ТекстПУ: (null), Группа: Для отладки
...
(Uint16)(2048), (((Uint32)2048)>>16), (Uint16)(20480), (((Uint32)20480)>>16),
31277, 377, 490,
0,
0,
0,
...
Uint16 const co1_SPIrange3rwCRC = CO1_SPI_START_ADDR+684;
Uint16 const co1_SPIrange3rwp = CO1_SPI_START_ADDR+686;
Uint16 const co1_SPIrange3rwpCRC = CO1_SPI_START_ADDR+686;
Uint16 const co1_SPIrange3rwps = CO1_SPI_START_ADDR+688;
Uint16 const co1_SPIrange3rwpsCRC = CO1_SPI_START_ADDR+688;
Uint16 const co1_SPIrange4rw = CO1_SPI_START_ADDR+690;
Uint16 const co1_SPIrange4rwCRC = CO1_SPI_START_ADDR+690;
Uint16 const co1_SPIrange4rwp = CO1_SPI_START_ADDR+692;
Uint16 const co1_SPIrange4rwpCRC = CO1_SPI_START_ADDR+692;
