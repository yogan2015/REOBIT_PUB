...
typedef   long    _iq1;
//---------------------------------------------------------------------------
#define   __IQ(A, N)	(long) ((float)(A) * (1L << (N))) 
...
#endif
//---------------------------------------------------------------------------
#define __IQtoF(A, N)	((float)(A) / (1L << (N)))
...
#endif
//---------------------------------------------------------------------------
extern long __IQsat(long A, long Pos, long Neg);

#define   _IQsat(A, Pos, Neg)  __IQsat(A, Pos, Neg)

//---------------------------------------------------------------------------

#define   _IQtoIQ(A, N1, N2)	(((N1) > (N2)) ? ((A) >> ((N1) - (N2))) : ((A) << ((N2) - (N1))))
...
//---------------------------------------------------------------------------
extern long __IQmpy(long A, long B, int N);
...
#endif
//---------------------------------------------------------------------------
extern long __IQdiv(long A, long B, int N);

#ifdef SW_IQMATH
#define _IQ30div(A, B)		__IQdiv(A, B, 30)
#define _IQ29div(A, B)		__IQdiv(A, B, 29)
#define _IQ28div(A, B)		__IQdiv(A, B, 28)
#define _IQ27div(A, B)		__IQdiv(A, B, 27)
#define _IQ26div(A, B)		__IQdiv(A, B, 26)
#define _IQ25div(A, B)		__IQdiv(A, B, 25)
#define _IQ24div(A, B)		__IQdiv(A, B, 24)
#define _IQ23div(A, B)		__IQdiv(A, B, 23)
#define _IQ22div(A, B)		__IQdiv(A, B, 22)
#define _IQ21div(A, B)		__IQdiv(A, B, 21)
#define _IQ20div(A, B)		__IQdiv(A, B, 20)
#define _IQ19div(A, B)		__IQdiv(A, B, 19)
#define _IQ18div(A, B)		__IQdiv(A, B, 18)
#define _IQ17div(A, B)		__IQdiv(A, B, 17)
#define _IQ16div(A, B)		__IQdiv(A, B, 16)
#define _IQ15div(A, B)		__IQdiv(A, B, 15)
#define _IQ14div(A, B)		__IQdiv(A, B, 14)
#define _IQ13div(A, B)		__IQdiv(A, B, 13)
#define _IQ12div(A, B)		__IQdiv(A, B, 12)
#define _IQ11div(A, B)		__IQdiv(A, B, 11)
#define _IQ10div(A, B)		__IQdiv(A, B, 10)
#define _IQ9div(A, B)		__IQdiv(A, B, 9)
#define _IQ8div(A, B)		__IQdiv(A, B, 8)
#define _IQ7div(A, B)		__IQdiv(A, B, 7)
#define _IQ6div(A, B)		__IQdiv(A, B, 6)
#define _IQ5div(A, B)		__IQdiv(A, B, 5)
#define _IQ4div(A, B)		__IQdiv(A, B, 4)
#define _IQ3div(A, B)		__IQdiv(A, B, 3)
#define _IQ2div(A, B)		__IQdiv(A, B, 2)
#define _IQ1div(A, B)		__IQdiv(A, B, 1)
...
#endif
//---------------------------------------------------------------------------
extern long __IQxmpy(long A, long B, int N);
