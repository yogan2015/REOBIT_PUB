...
#define UD_CONTROL_OFF NT_GPIOG->MASKLOWBYTE_bit[64].MASKLB = 0 // операция для выключения
#define UD_CONTROL_ON NT_GPIOG->MASKLOWBYTE_bit[64].MASKLB = 64 // операция для включения
#else
