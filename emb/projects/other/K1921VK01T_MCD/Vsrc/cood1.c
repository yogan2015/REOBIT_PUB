...
Uint16 const co1_numOfInd = 130;
// Номер перечесления для групп
Uint16 const co1_groupEnum = 15;
// Хэш-сумма:
Uint32 const co1_odHash[4] = {0xB9C45032, 0xCBA147EB, 0xC14657A4, 0x98DECC5B};
...
Uint16 const co1_SPIrange3rwCRC = CO1_SPI_START_ADDR+688;
Uint16 const co1_SPIrange3rwp = CO1_SPI_START_ADDR+690;
Uint16 const co1_SPIrange3rwpCRC = CO1_SPI_START_ADDR+690;
Uint16 const co1_SPIrange3rwps = CO1_SPI_START_ADDR+692;
Uint16 const co1_SPIrange3rwpsCRC = CO1_SPI_START_ADDR+692;
Uint16 const co1_SPIrange4rw = CO1_SPI_START_ADDR+694;
Uint16 const co1_SPIrange4rwCRC = CO1_SPI_START_ADDR+694;
Uint16 const co1_SPIrange4rwp = CO1_SPI_START_ADDR+696;
Uint16 const co1_SPIrange4rwpCRC = CO1_SPI_START_ADDR+696;
Uint16 const co1_SPIrange4rwps = CO1_SPI_START_ADDR+698;
Uint16 const co1_SPIrange4rwpsCRC = CO1_SPI_START_ADDR+698;
Uint16 const co1_SPIrange5rw = CO1_SPI_START_ADDR+700;
Uint16 const co1_SPIrange5rwCRC = CO1_SPI_START_ADDR+1373;
Uint16 const co1_SPIrange5rwp = CO1_SPI_START_ADDR+1375;
Uint16 const co1_SPIrange5rwpCRC = CO1_SPI_START_ADDR+1379;
Uint16 const co1_SPIrange5rwps = CO1_SPI_START_ADDR+1381;
Uint16 const co1_SPIrange5rwpsCRC = CO1_SPI_START_ADDR+1381;
