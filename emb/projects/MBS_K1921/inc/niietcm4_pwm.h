...
typedef enum
{
    ...
    PWM_DB_In_AFallBRise,      /*!< Входной сигнал B задержан переднему фронту, A - по заднему.  */
...
#define PWM_TZ_Channel_4    ((uint32_t)0x00000008)      /*!< Сигнал аварии 3 */
#define PWM_TZ_Channel_3    ((uint32_t)0x00000010)      /*!< Сигнал аварии 4 */
