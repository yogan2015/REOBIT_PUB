/******************************************************************************
 * @file		PWM_macros.h
 * @brief		Заголовочный файл с макросами для удобной инициализации модулей ШИМ
 * @version		v1.0
...
#ifndef VINCLUDE_PWM_MACROS_H_
#define VINCLUDE_PWM_MACROS_H_

//Макросы для удобства настройки модулей ШИМ
