...
/**
  * @brief  Выбор максимальной нагрузочной способности пина.
  */
...
/**
  * @brief Макрос проверки аргументов типа @ref GPIO_Load_TypeDef.
  */
...
typedef struct
{
    ...
    GPIO_Load_TypeDef GPIO_Load;           /*!< Определяет макисальную нагрузку выбранных пинов.
                                               Параметр может принимать любое значение из @ref GPIO_Load_TypeDef. */
