...
typedef enum
{
    ...
    ADC_SEQ_StartEvent_PWM0    = ((uint32_t)0x6),    /*!< Сигнал от блока 0 ШИМ. */
    ADC_SEQ_StartEvent_PWM1    = ((uint32_t)0x7),    /*!< Сигнал от блока 1 ШИМ. */
    ADC_SEQ_StartEvent_PWM2    = ((uint32_t)0x8),    /*!< Сигнал от блока 2 ШИМ. */
    ADC_SEQ_StartEvent_PWM3    = ((uint32_t)0x9),    /*!< Сигнал от блока 3 ШИМ. */
    ADC_SEQ_StartEvent_PWM4    = ((uint32_t)0xA),    /*!< Сигнал от блока 4 ШИМ. */
    ADC_SEQ_StartEvent_PWM5    = ((uint32_t)0xB),    /*!< Сигнал от блока 5 ШИМ. */
