...
void Init_TIM0()
{
    ...
    NT_TIMER0->RELOAD                       = (0b1111111111111);        // 3,57 kHz 2^13 дискрет
...
void Init_PWM_common()
{
    ...
    NT_PWM0->TBCTL = PWM_TBCTL_CTRMODE_Msk  | PWM_TBCTL_PHSEN_Msk   | (0b01 << PWM_TBCTL_SYNCOSEL_Pos)  | PWM_TBCTL_PHSDIR_Msk;
    ...
    // Период таймера
    NT_PWM0->TBPRD = 0x1FFF;    // 2^13 - 3,57kHz
    NT_PWM1->TBPRD = 0x1FFF;              
    NT_PWM2->TBPRD = 0x1FFF;              
    NT_PWM3->TBPRD = 0x1FFF;              
    NT_PWM4->TBPRD = 0x1FFF;              
    NT_PWM5->TBPRD = 0x1FFF;   
    ...
    NT_PWM0->CMPA = 0x2000; NT_PWM0->CMPB = 0x2000;      // Никаких событий не происходит, т.к. CMPA>TBPRD
    NT_PWM1->CMPA = 0x2000; NT_PWM1->CMPB = 0x2000;
    NT_PWM2->CMPA = 0x2000; NT_PWM2->CMPB = 0x2000;
    NT_PWM3->CMPA = 0x2000; NT_PWM3->CMPB = 0x2000;
    NT_PWM4->CMPA = 0x2000; NT_PWM4->CMPB = 0x2000;
    NT_PWM5->CMPA = 0x2000; NT_PWM5->CMPB = 0x2000;
    ...
    // Дейтвия при аварии
    NT_PWM0->TZCTL |= (10 << PWM_TZCTL_TZA_Pos) | (10 << PWM_TZCTL_TZB_Pos);    // Оба выхода в ноль
    NT_PWM1->TZCTL |= (10 << PWM_TZCTL_TZA_Pos) | (10 << PWM_TZCTL_TZB_Pos);
    NT_PWM2->TZCTL |= (10 << PWM_TZCTL_TZA_Pos) | (10 << PWM_TZCTL_TZB_Pos);
    NT_PWM3->TZCTL |= (10 << PWM_TZCTL_TZA_Pos) | (10 << PWM_TZCTL_TZB_Pos);
    NT_PWM4->TZCTL |= (10 << PWM_TZCTL_TZA_Pos) | (10 << PWM_TZCTL_TZB_Pos);
    NT_PWM5->TZCTL |= (10 << PWM_TZCTL_TZA_Pos) | (10 << PWM_TZCTL_TZB_Pos);
