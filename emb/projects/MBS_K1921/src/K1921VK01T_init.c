...
void K1921VK01T_GPIO_SafeInit()
{
	...
	NT_COMMON_REG->GPIOPCTLA_bit.PIN13 = 2;	//RAM_ADDR[5]
	NT_COMMON_REG->GPIOPCTLA_bit.PIN14 = 2;	//RAM_ADDR[6]
	NT_COMMON_REG->GPIOPCTLA_bit.PIN15 = 2;	//RAM_ADDR[7]
	...
	NT_COMMON_REG->GPIOPCTLG_bit.PIN2 = 0;	//SSP_RxD[1]
	NT_COMMON_REG->GPIOPCTLG_bit.PIN3 = 0;	//SSP_FSS[3]
	NT_COMMON_REG->GPIOPCTLG_bit.PIN4 = 0;	//UART_TxD[2]
	NT_COMMON_REG->GPIOPCTLG_bit.PIN5 = 0;	//RAM_DATA[13]
	NT_COMMON_REG->GPIOPCTLG_bit.PIN6 = 0;	//RAM_DATA[15]
	NT_COMMON_REG->GPIOPCTLG_bit.PIN7 = 1;	//RAM_DATA[5]
