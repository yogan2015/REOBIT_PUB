...
void Exec(void)
{
 ...
 // cIu = _IQ24mpy((((*((int *)(*v->offset + IPM0_Iw)))) << 12)) << 5, v->g_Iw);
  ...
  {
    case 0:
      cIu = _IQ24mpy(((((*((int *)(*v->offset + IPM0_Iu)))) << 12) - 8388607) << 5, v->g_Iu);
      cIv = _IQ24mpy(((((*((int *)(*v->offset + IPM0_Iv)))) << 12) - 8388607) << 5, v->g_Iv);
      cIw = -(cIu + cIv);
      break;
    case 1:
      cIv = _IQ24mpy(((((*((int *)(*v->offset + IPM0_Iv)))) << 12) - 8388607) << 5, v->g_Iv);
      cIw = _IQ24mpy(((((*((int *)(*v->offset + IPM0_Iw)))) << 12) - 8388607) << 5, v->g_Iw);
      cIu = -(cIv + cIw);
      break;
    case 2:
      cIu = _IQ24mpy(((((*((int *)(*v->offset + IPM0_Iu)))) << 12) - 8388607) << 5, v->g_Iu);
...
//  v->T =    _IQ8mpy((*((int *)(*v->offset + IPM0_T))) - 2048 - v->o_T, v->g_T);
  v->U_dc = _IQ24mpy(((((*((int *)(*v->offset + IPM0_UDC)))) << 12) - v->o_Udc) << 5, v->g_Udc);
  v->T    = _IQ24mpy(((((*((int *)(*v->offset + IPM0_T)))) << 12) - v->o_T) << 5, v->g_T);
